...
The different wrap files are available [here](https://github.com/pierre-24/libcint-meson/releases/tag/v0.0.3) (bleeding edge version are available [here](https://github.com/pierre-24/libcint-meson/releases/tag/latest)).
...
cd subprojects
wget https://github.com/pierre-24/libcint-meson/releases/download/v0.0.3/libcint_v6.1.2.wrap -O libcint.wrap
```
